...
class HomeScreen extends StatelessWidget {
  ...
  Scholarship(
    ...
    description: 'Beca destinada a estudiantes de Iberoamérica para realizar estudios en España o Brasil.',
  ...
  Scholarship(
    ...
    description: 'Beca para estudiantes mexicanos que deseen realizar estudios de posgrado en el extranjero en el área de investigación.',
    eligibilityRequirements: [
  ...
  Scholarship(
    ...
    description: 'Beca para estudiantes internacionales que deseen cursar un programa de posgrado en los Estados Unidos.',
    eligibilityRequirements: [
  ...
  Scholarship(
    ...
    description: 'Beca destinada a estudiantes internacionales para programas de maestría en Europa.',
    eligibilityRequirements: [
  ...
  Scholarship(
    ...
    description: 'Beca para estudiantes que buscan convertirse en líderes en sus comunidades mediante el financiamiento de programas educativos.',
    eligibilityRequirements: [
  ...
  Scholarship(
    title: 'Beca de Investigación en el Extranjero para Estudiantes Mexicanos',
    amount: 15000,
    ...
    isSaved: true,
    organization: 'ASEA',
    description: 'Beca para estudiantes mexicanos interesados en realizar investigaciones en el extranjero.',
    eligibilityRequirements: [
  ...
  Scholarship(
    ...
    description: 'Beca para estudios de maestría en universidades del Reino Unido.',
    eligibilityRequirements: [
  ...
  Scholarship(
    ...
    description: 'Beca dirigida a mujeres que deseen realizar estudios en ciencia y tecnología.',
    eligibilityRequirements: [
      '• Ser mujer',
  ...
  Scholarship(
    ...
    description: 'Beca para estudiantes de posgrado interesados en realizar estudios en EE. UU.',
    eligibilityRequirements: [
      '• Ser estudiante internacional',
